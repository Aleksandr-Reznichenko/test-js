...
refs.controlsDiv.classList.add('controls');
refs.boxesNewList.classList.add('boxes');
refs.inputEl.classList.add('controls-input');
refs.inputEl.setAttribute('value', '1');
refs.btnCreateEl.classList.add('btn-create');
refs.btnDestroyEl.classList.add('btn-destroy');
